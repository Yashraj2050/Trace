...
export function ProductShowcase() {
  return (
    <section
      id="product-showcase"
      className="w-full py-32 px-6 md:px-12 bg-[#0a0a0a] text-white border-t border-white/10 overflow-hidden"
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          {/* Mac window controls */}
          <div
            className="flex items-center gap-2 px-4 py-3 border-b border-white/10 bg-[#151515]"
            aria-hidden="true"
          >
          ...
          <div className="flex flex-col md:flex-row h-full">
            {/* Sidebar Mock */}
            <div
              className="hidden md:flex flex-col w-64 border-r border-white/10 p-6 gap-6 bg-[#0d0d0d]"
              aria-hidden="true"
            >
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3 px-3 py-2 rounded-md bg-white/10 text-white text-sm font-medium">
                  <Activity className="w-4 h-4" aria-hidden="true" /> Overview
                </div>
                <div className="flex items-center gap-3 px-3 py-2 rounded-md text-white/50 text-sm hover:text-white transition-colors">
                  <Leaf className="w-4 h-4" aria-hidden="true" /> Logs
                </div>
                <div className="flex items-center gap-3 px-3 py-2 rounded-md text-white/50 text-sm hover:text-white transition-colors">
                  <Cpu className="w-4 h-4" aria-hidden="true" /> Intelligence
                </div>
              </div>
            </div>

            {/* Main Content Mock */}
            <div className="flex-1 p-6 md:p-10 bg-[#0a0a0a]" aria-hidden="true">
              <div className="flex justify-between items-end mb-10">
                ...
                <div className="hidden sm:flex items-center gap-2 text-emerald-400 text-sm bg-emerald-400/10 px-3 py-1.5 rounded-full border border-emerald-400/20">
                  <ArrowUpRight className="w-4 h-4" aria-hidden="true" /> 12.4%
                  reduction
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                {stats.map((stat) => (
                  <div
                    key={stat.label}
                    className="p-5 rounded-lg border border-white/10 bg-[#111]"
                  >
              ...
              <div className="w-full h-64 rounded-lg border border-white/10 bg-[#111] p-5 flex flex-col relative overflow-hidden">
                ...
                {/* Overlay gradient */}
                <div className="absolute top-0 right-0 w-32 h-full bg-gradient-to-l from-[#111] to-transparent pointer-events-none" />
              </div>
            </div>
          </div>
        </motion.div>
