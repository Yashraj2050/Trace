...
export function CtaSection() {
  return (
    <section
      className="w-full py-32 px-6 md:px-12 bg-white text-black flex flex-col items-center justify-center text-center"
    ...
    >
      ...
      >
        ...
        <Link
          href="/signup"
          className="inline-flex items-center justify-center bg-black text-white px-10 py-5 rounded-full font-medium text-lg transition-transform hover:scale-105 active:scale-95"
