...
const EarthGlobe = dynamic(
  () => import("@/components/landing/globe").then((mod) => mod.EarthGlobe),
  {
    ssr: false,
    loading: () => (
      <div
...
export function HeroSection() {
  return (
    <section
      className="relative w-full min-h-screen flex flex-col items-center justify-center pt-32 pb-16 px-6 md:px-12 bg-[#0a0a0a] overflow-hidden"
    ...
    >
      ...
      <div
        className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_center,transparent_0%,#0a0a0a_80%)] pointer-events-none"
        aria-hidden="true"
      />
      ...
      <div className="z-10 flex flex-col items-center text-center max-w-5xl mx-auto mt-auto mb-auto">
        ...
        >
          It&apos;s a behavior system. Trace predicts, analyzes, and reshapes
          your environmental impact with machine precision.
        </motion.p>
        ...
        >
          <Link
            href="/login"
            className="group flex items-center justify-center gap-2 bg-white text-black px-8 py-4 rounded-full font-medium text-sm transition-transform hover:scale-105 active:scale-95"
          ...
          <Link
            ...
            className="flex items-center justify-center px-8 py-4 rounded-full font-medium text-sm text-white border border-white/20 transition-colors hover:bg-white/10"
